module.exports = {
  ...
  script: function (context, _content, partial, slot, options) {
    ...
    out.push(
      options.applyIndent(partial(context.main, 'codeblock'), '    ') + '\n',
    )
    ...
    if (blockNames.length > 0) {
      ...
      for (let i2 = 0; i2 < blockNames.length; i2 += 1) {
        ...
        out.push('      var out = []\n')
        out.push(
          options.applyIndent(partial(block.main, 'codeblock'), '      '),
        )
        if (directives.chunks) {
          out.push('\n')
          out.push("      if(out.some(t=>typeof t == 'object')){\n")
    ...
    if (slotNames.length > 0) {
      ...
      for (let i2 = 0; i2 < slotNames.length; i2 += 1) {
        ...
        out.push('      var out = []\n')
        out.push(
          options.applyIndent(partial(slot2.main, 'codeblock'), '      '),
        )
        if (directives.chunks) {
          out.push('\n')
          out.push("      if(out.some(t=>typeof t == 'object')){\n")
