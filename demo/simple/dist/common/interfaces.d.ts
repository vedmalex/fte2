...
export type ContentFunction = (name: string, context: HashType, content: ContentFunction, partial: PartialFunction, slot: SlotFunction) => string | Array<{
    name: string;
    content: string;
}>;
...
export type BlockRunFunction<T extends DefaultFactoryOption> = (context: HashType, content: ContentFunction, partial: PartialFunction, slot: SlotFunction, options: T) => string | Array<{
    name: string;
    content: string;
}>;
...
export type BlocksHash<T extends DefaultFactoryOption> = HashTypeGeneric<BlockRunFunction<T>>;
