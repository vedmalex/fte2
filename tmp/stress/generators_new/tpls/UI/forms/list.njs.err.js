...
script: function (entity, _content, partial, slot, options){
    ...
    var out = []
     ...
     const listActions = entity.actions.filter(a=> a.actionType==='listAction')  const itemActions = entity.actions.filter(a=> a.actionType==='itemAction') 
    out.push("import React, { useContext, cloneElement } from \"react\";" + "import { UIXContext } from '../contexts';\n");
    out.push("import {\n");
