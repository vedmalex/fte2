...
export type BlockRunFunction = <T = any, OPTIONS extends DefaultFactoryOption = DefaultFactoryOption>(context: T, content: ContentFunction, partial: PartialFunction, slot: SlotFunction, options: OPTIONS) => string | Array<ChunkContent>;
