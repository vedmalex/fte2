...
// при изменении версии @swc/core, необходимо проверить этот файл на наличие изменений в основной ветке
// https://github.com/swc-project/swc/blob/main/node-swc/src/Visitor.ts
// https://raw.githubusercontent.com/swc-project/swc/main/node-swc/src/Visitor.ts
