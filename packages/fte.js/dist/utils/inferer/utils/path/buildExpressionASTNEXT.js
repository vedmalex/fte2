...
function getParamsFromNode(ast) {
    ...
    switch (type) {
        ...
        case 'OptionalCallExpression':
            keys = [
                { property: 'callee', term: false, type: 'call' },
        ...
        case 'OptionalMemberExpression':
            keys = [
                { property: 'object', term: false, type: 'member' },
                { property: 'optional', term: false },
                { property: 'property', term: false, type: 'member' },
            ];
            type = 'member';
            hoist = true;
            break;
        ...
        case 'AssignmentPattern':
            ...
            break;
        case 'RestElement':
            keys = [{ property: 'argument', term: true, type: 'rest' }];
            type = 'rest';
            term = false;
            break;
        case 'SpreadElement':
...
//# sourceMappingURL=buildExpressionASTNEXT.js.map