                ...
                if (Array.isArray(value)) {
                    ...
                    for (let i = 0; i < value.length; i++) {
                        if (typeof value[i] === 'object') {
                            node[key].push(traverse(value[i], parent));
                        }
                        else {
                            node[key] = value[i];
                        }
                    ...
                    if (typeof value === 'object') {
                        node[key] = traverse(value, parent);
                    }
                    else {
                        node[key] = value;
                    }
...
//# sourceMappingURL=buildAstObject%20copy.js.map