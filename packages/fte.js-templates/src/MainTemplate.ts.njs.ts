...
export default {
  ...
  blocks: {
    maincontent: function (
      directives: { content: any; context: any },
      _content: any,
      partial: any,
      slot: any,
      options: any,
    ...
    'chunks-start': function (directives: { chunks: any }, _content: any, partial: any, slot: any, options: any) {
      var out: Array<string> = []
      if (directives.chunks) {
        out.push('\n')
    ...
    'chunks-finish': function (
      directives: { chunks: any; useHash: any; includeMainChunk: any },
      _content: any,
      partial: any,
      slot: any,
      options: any,
