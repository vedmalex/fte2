...
describe('Parent Block Validation Logic', () => {
  test('should identify blocks declared in child template', () => {
...
<# end #>`
    ...
    const extendDirective = ast.main.find(
      (node) =>
        node.type === 'directive' &&
        node.content &&
  ...
  test('should parse block positions for diagnostics', () => {
...
<# end #>`
  ...
  test('should handle templates without extend directive', () => {
...
<# end #>`
  ...
  test('should handle complex extend directive patterns', () => {
    const patterns = [
      `<#@ extend 'base.nhtml' #>`,
      `<#@ extend "base.nhtml" #>`,
      `<#@extend 'base.nhtml'#>`,
