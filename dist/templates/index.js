...
const es6module_ts_njs_1 = __importDefault(require("./es6module.ts.njs"));
const MainTemplate_njs_1 = __importDefault(require("./MainTemplate.njs"));
const MainTemplate_ts_njs_1 = __importDefault(require("./MainTemplate.ts.njs"));
...
const singlefile_ts_njs_1 = __importDefault(require("./singlefile.ts.njs"));
...
const standalone_index_ts_njs_1 = __importDefault(require("./standalone.index.ts.njs"));
const standalone_njs_1 = __importDefault(require("./standalone.njs"));
const standalone_ts_njs_1 = __importDefault(require("./standalone.ts.njs"));
const templates = {
